...
def get_chart_data(anio="2025", empleado_id=None, supervisor_id=None):
    ...
    groups_map = {
        ...
        "Fide / Reemp Pospago": ["Fidepuntos Pospago", "Fidepuntos Disminucion", "Reemplazo Pospago", "Reemplazo Disminucion"],
        "Fide / Reemp Up": ["Fidepuntos Aumento", "Reemplazo Aumento"],
    ...
    color_map = {
        ...
        "Fide / Reemp Pospago": "rgba(46, 204, 113, 1)",
        "Fide / Reemp Up": "rgba(243, 156, 18, 1)",
